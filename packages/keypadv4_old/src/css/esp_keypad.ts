...
.mdc-button:not(:disabled) {
  color: #6200ee;
  /* @alternate */
  color: var(--mdc-text-button-label-text-color, var(--mdc-theme-primary, var(--currentColor)));
}
.mdc-button:disabled {
...
.mdc-button--outlined:not(:disabled) {
  ...
  /* @alternate */
  color: var(--mdc-outlined-button-label-text-color, var(--mdc-theme-primary, var(--currentColor)));
}
.mdc-button--outlined:disabled {
  color: var(--currentColor);
  /* @alternate */
  color: var(--mdc-outlined-button-disabled-label-text-color, var(--currentColor));
}
...
.mdc-button--outlined .mdc-button__ripple::after {
  ...
  /* @alternate */
  background-color: var(--mdc-outlined-button-hover-state-layer-color, var(--mdc-theme-primary, var(--currentColor)));
}
...
.mdc-button--outlined:not(:disabled) {
  ...
  /* @alternate */
  border-color: var(--mdc-outlined-button-outline-color, var(--currentColor));
}
.mdc-button--outlined:disabled {
  border-color: var(--currentColor));
  /* @alternate */
  border-color: var(--mdc-outlined-button-disabled-outline-color, var(--currentColor));
}
