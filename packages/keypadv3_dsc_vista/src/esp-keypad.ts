        ...
        return html`
         ...
         <div class='container' @click="${this.stopPropagation}" color-scheme="${this.scheme}">
              ...
              <div class='keypad'>
                ...
                <div class='pad'>
                    <div class='mdc-button' style='color:${this._status_A_state};'><span class="icon-label">${this._status_A}</span>
 <iconify-icon
          icon=${this._iconA}
          height="20px"
        ...
        ></iconify-icon>
                    ...
                    <div class='mdc-button' style='color:${this._status_B_state};'><span class="icon-label">${this._status_B}</span>
 <iconify-icon
          icon=${this._iconB}
          height="20px"
        ...
        ></iconify-icon>
                    ...
                    <div class='mdc-button' style='color:${this._status_C_state};'><span class="icon-label">${this._status_C}</span>
 <iconify-icon
          .icon=${this._iconC}
          height="20px"
        ...
        ></iconify-icon>
                    ...
                    <div class='mdc-button' style='color:${this._status_D_state};'><span class="icon-label">${this._status_D}</span>
 <iconify-icon
          .icon=${this._iconD}
          height="20px"
        ...
        ></iconify-icon>
                ...
                <div class='pad'>
                    <div class='mdc-button ' style='color:${this._status_E_state};'><span class="icon-label">${this._status_E}</span>
   <iconify-icon
          icon=${this._iconE}
          height="20px"
        ...
        ></iconify-icon>
                    ...
                    <div class='mdc-button ' style='color:${this._status_F_state};'><span class="icon-label">${this._status_F}</span>
 <iconify-icon
          icon=${this._iconF}
          height="20px"
        ...
        ></iconify-icon>
                    ...
                    <div class='mdc-button  ' style='color:${this._status_G_state};'><span class="icon-label">${this._status_G}</span>
 <iconify-icon
          icon=${this._iconG}
          height="20px"
        ...
        ></iconify-icon>
                    ...
                    <div class='mdc-button' style='color:${this._status_H_state};'><span class="icon-label">${this._status_H}</span>
 <iconify-icon
          icon=${this._iconH}
          height="20px"
                    ...
                    if (id_code == this._line1id.replace("?", this.current_partition)) {
                        ...
                        if (id_code == this._line2id.replace("?", this.current_partition)) {
                            ...
                            if (id_code == this._sensor_A.replace("?", this.current_partition)) {
                                ...
                                this._status_A_state = data.value ? this._status_A_color : 'var(--disabled)';
                            } else
                                if (id_code == this._sensor_B.replace("?", this.current_partition)) {
                                    ...
                                    this._status_B_state = data.value ? this._status_B_color : 'var(--disabled)';
                                } else
                                    if (id_code == this._sensor_C.replace("?", this.current_partition)) {
                                        ...
                                        this._status_C_state = data.value ? this._status_C_color : 'var(--disabled)';
                                    } else
                                        if (id_code == this._sensor_D.replace("?", this.current_partition)) {
                                            ...
                                            this._status_D_state = data.value ? this._status_D_color : 'var(--disabled)';
                                        } else
                                            if (id_code == this._sensor_E.replace("?", this.current_partition)) {
                                                ...
                                                this._status_E_state = data.value ? this._status_E_color : 'var(--disabled)';
                                            } else
                                                if (id_code == this._sensor_F.replace("?", this.current_partition)) {
                                                    ...
                                                    this._status_F_state = data.value ? this._status_F_color : 'var(--disabled)';
                                                } else
                                                    if (id_code == this._sensor_G.replace("?", this.current_partition)) {
                                                        ...
                                                        this._status_G_state = data.value ? this._status_G_color : 'var(--disabled)';
                                                    } else
                                                        if (id_code == this._sensor_H.replace("?", this.current_partition)) {
                                                            ...
                                                            this._status_H_state = data.value ? this._status_H_color : 'var(--disabled)';
                                                        }
                }
            }
